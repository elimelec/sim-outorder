...
namespace JMetalCSharp.Metaheuristics.NSGAII
{
	...
	public class ComparerP: IEqualityComparer<Solution>
	{

		public bool Equals(Solution x, Solution y)
		{
			var sx = x.Variable[0] as ConfigurationVariable;
			var sy = y.Variable[0] as ConfigurationVariable;

			return sx.Value.EqualWith(sy.Value);
		}
		public int GetHashCode(Solution sol)
		{
			var sx = sol.Variable[0] as ConfigurationVariable;
			return sx.Value.GetHashCode ();
		}
	}
}
