...
sim: command line: ./sim-outorder -redir:sim ../gemhSim.res -redir:prog gemhProg.res -max:inst 10000000 -fetch:ifqsize 4 -fetch:mplat 3 -decode:width 4 -issue:width 4 -issue:inorder False -issue:wrongpath True -ruu:size 64 -lsq:size 8 -res:ialu 4 -res:imult 1 -res:memport 2 -res:fpalu 4 -res:fpmult 1 -cache:dl1lat 1 -mem:width 1024 -tlb:lat 256 -bpred:bimod 2048 -bpred:2lev 1 1024 8 0 -bpred:btb 512 4 -cache:dl1 dl1:256:32:1:l -cache:dl2 dl2:256:32:1:l -cache:il1 il1:256:32:1:l -cache:il2 il2:256:32:1:l -tlb:dtlb dtlb:32:4096:4:l -tlb:itlb itlb:16:4096:4:l -cache:flush False -cache:icompress False applu.ss 

sim: simulation started @ Fri Dec 30 08:28:08 2016, options follow:
...
sim_total_insn             10174488 # total number of instructions executed
sim_total_refs              1561016 # total number of loads and stores executed
sim_total_loads             1394078 # total number of loads executed
sim_total_stores        166938.0000 # total number of stores executed
sim_total_branches           170666 # total number of branches executed
sim_cycle                   6625598 # total simulation time in cycles
sim_IPC                      1.5093 # instructions per cycle
sim_CPI                      0.6626 # cycles per instruction
sim_exec_BW                  1.5356 # total instructions (mis-spec + committed) per cycle
sim_IPB                     58.7848 # instruction per branch
IFQ_count                  21753197 # cumulative IFQ occupancy
IFQ_fcount                  5328259 # cumulative IFQ full count
ifq_occupancy                3.2832 # avg IFQ occupancy (insn's)
ifq_rate                     1.5356 # avg IFQ dispatch rate (insn/cycle)
ifq_latency                  2.1380 # avg IFQ occupant latency (cycle's)
ifq_full                     0.8042 # fraction of time (cycle's) IFQ was full
RUU_count                 256174556 # cumulative RUU occupancy
RUU_fcount                   420263 # cumulative RUU full count
ruu_occupancy               38.6644 # avg RUU occupancy (insn's)
ruu_rate                     1.5356 # avg RUU dispatch rate (insn/cycle)
ruu_latency                 25.1781 # avg RUU occupant latency (cycle's)
ruu_full                     0.0634 # fraction of time (cycle's) RUU was full
LSQ_count                  37090821 # cumulative LSQ occupancy
LSQ_fcount                  2845203 # cumulative LSQ full count
lsq_occupancy                5.5981 # avg LSQ occupancy (insn's)
lsq_rate                     1.5356 # avg LSQ dispatch rate (insn/cycle)
lsq_latency                  3.6455 # avg LSQ occupant latency (cycle's)
lsq_full                     0.4294 # fraction of time (cycle's) LSQ was full
sim_slip                  304432149 # total number of slip cycles
avg_sim_slip                30.4432 # the average slip between issue and retirement
bpred_bimod.lookups          170818 # total number of bpred lookups
...
il1.accesses               10332426 # total number of accesses
il1.hits                   10273312 # total number of hits
...
dl1.accesses                1511021 # total number of accesses
dl1.hits                    1398919 # total number of hits
dl1.misses                   112102 # total number of misses
dl1.replacements             111846 # total number of replacements
dl1.writebacks                33647 # total number of writebacks
dl1.invalidations                 0 # total number of invalidations
dl1.miss_rate                0.0742 # miss rate (i.e., misses/ref)
dl1.repl_rate                0.0740 # replacement rate (i.e., repls/ref)
dl1.wb_rate                  0.0223 # writeback rate (i.e., wrbks/ref)
dl1.inv_rate                 0.0000 # invalidation rate (i.e., invs/ref)
dl2.accesses                 145749 # total number of accesses
dl2.hits                      33647 # total number of hits
dl2.misses                   112102 # total number of misses
dl2.replacements             111846 # total number of replacements
dl2.writebacks                33647 # total number of writebacks
dl2.invalidations                 0 # total number of invalidations
dl2.miss_rate                0.7691 # miss rate (i.e., misses/ref)
dl2.repl_rate                0.7674 # replacement rate (i.e., repls/ref)
dl2.wb_rate                  0.2309 # writeback rate (i.e., wrbks/ref)
dl2.inv_rate                 0.0000 # invalidation rate (i.e., invs/ref)
itlb.accesses              10332426 # total number of accesses
itlb.hits                  10332397 # total number of hits
...
dtlb.accesses               1511431 # total number of accesses
dtlb.hits                   1510792 # total number of hits
...
mem.page_mem                  1712k # total size of memory pages allocated
mem.ptab_misses                 436 # total first level page table misses
mem.ptab_accesses          64156328 # total page table accesses
